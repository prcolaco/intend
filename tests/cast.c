...
void cast_test(void)
{
  ...
  test_assert(val && TYPE_OF(val) == VALUE_TYPE_VOID);
  value_free(val);
  ...
  test_assert(val && TYPE_OF(val) == VALUE_TYPE_BOOL &&
              BOOL_OF(val) == 0);
  value_free(val);
  ...
  test_assert(val && TYPE_OF(val) == VALUE_TYPE_INT &&
              INT_OF(val) == 0);
  value_free(val);
  ...
  test_assert(val && TYPE_OF(val) == VALUE_TYPE_FLOAT &&
              FLOAT_OF(val) == 0.0);
  value_free(val);
  ...
  test_assert(val && TYPE_OF(val) == VALUE_TYPE_STRING &&
              STRLEN_OF(val) == 0 &&
              STR_OF(val) == NULL);
  value_free(val);
  ...
  test_assert(val && TYPE_OF(val) == VALUE_TYPE_ARRAY &&
              ARRLEN_OF(val) == 1 &&
  ...
  test_assert(val && TYPE_OF(val) == VALUE_TYPE_STRUCT &&
              elem && elem->type == VALUE_TYPE_VOID);
  value_free(elem);
  value_free(val);
  ...
  test_assert(val && TYPE_OF(val) == VALUE_TYPE_FN);
  value_free(val);
